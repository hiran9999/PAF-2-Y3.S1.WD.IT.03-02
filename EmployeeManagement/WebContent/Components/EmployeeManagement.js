...
$(document).on("click", "#btnSave", function(event) {
	...
	$.ajax({
		url : "EmployeeManagementAPI",
		type : type,
		data : $("#formEmployeeManagement").serialize(),
		dataType : "text",
